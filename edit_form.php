...
/**
 * simpleblock instance configuration form
 *
 ...
 */
class block_simpleblock_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $sizes = array(
            'custom'=>get_string('custom', 'block_simpleblock'),
            'small'=>get_string('small', 'block_simpleblock'),
            'medium'=>get_string('medium', 'block_simpleblock'),
            'large'=>get_string('large', 'block_simpleblock'));

        $mform->addElement('select', 'config_size',
                get_string('size', 'block_simpleblock'), $sizes);
